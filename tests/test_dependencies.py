...
class TestDependency:
    ...
    def test_dependency_defaults(self):
        ...
        dep = Dependency(package_name="test-package", import_name="test_package")
...
class TestDependencyChecker:
    ...
    def test_check_package_installed(self):
        ...
        dep = Dependency(
            package_name="numpy", import_name="numpy", min_version="1.24.0"
        )
    ...
    def test_critical_dependencies_installed(self):
        ...
        for package in critical_packages:
            ...
            installed_packages = [
                pkg for pkg, data in results.items() if data["installed"]
            ]
